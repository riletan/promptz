    ...
    >
      <SpaceBetween size="s">
        <Container>
          ...
          lifecycle. Whether you are looking for inspiration, patterns, or best
          ...
          <ul>
            <li>
              ...
              requirements gathering to code deployment, we have got examples
              that fit every use case.
            </li>
            <li>
