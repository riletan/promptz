...
Object.defineProperty(exports, "__esModule", { value: !0 }),
  (exports.Retry =
    exports.includeStackTraces =
    exports.MISSING_PHYSICAL_ID_MARKER =
    exports.CREATE_FAILED_PHYSICAL_ID_MARKER =
      void 0),
...
async function submitResponse(status, event, options = {}) {
  const json = {
      ...
      PhysicalResourceId:
        event.PhysicalResourceId || exports.MISSING_PHYSICAL_ID_MARKER,
    ...
    loggingSafeUrl = `${parsedUrl.protocol}//${parsedUrl.hostname}/${parsedUrl.pathname}?***`;
  options?.noEcho
    ? (0, util_1.log)(
        "submit redacted response to cloudformation",
        loggingSafeUrl,
        redactDataFromPayload(json),
      )
    : (0, util_1.log)(
  ...
  const retryOptions = { attempts: 5, sleep: 1e3 };
  ...
  return async (event) => {
    ...
    try {
      ...
      if (e instanceof Retry)
        throw ((0, util_1.log)("retry requested by handler"), e);
...
function redactDataFromPayload(payload) {
  ...
  if (redactedPayload.Data) {
    ...
    for (const key of keys) redactedPayload.Data[key] = "*****";
  }
