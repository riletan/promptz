...
type AmplifyBackendEnvVars = {
  AMPLIFY_DATAPROMPTZ_GRAPHQL_ENDPOINT: string;
  AMPLIFY_DATAPROMPTZ_MODEL_INTROSPECTION_SCHEMA_BUCKET_NAME: string;
  AMPLIFY_DATAPROMPTZ_MODEL_INTROSPECTION_SCHEMA_KEY: string;
  AMPLIFY_DATA_DEFAULT_NAME: string;
  PROMPTZ_GRAPHQL_ENDPOINT: string;
};
